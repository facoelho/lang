...
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td>
            <div id="botoes">
                    <?php
                    echo $this->Html->link($this->Html->image("botoes/view_2_min.png", array("alt" => "Visualizar", "title" => "Visualizar")), array('action' => 'view', $empresa['Empresa']['id']), array('escape' => false));
