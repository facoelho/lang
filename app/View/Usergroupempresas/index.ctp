    ...
    <?php foreach ($usergroupempresas as $usergroupempresa): ?>
        <tr>
            ...
            <td>
                <div id="botoes">
                    <?php
                    echo $this->Html->link($this->Html->image("botoes/view_2_min.png", array("alt" => "Visualizar", "title" => "Visualizar")), array('action' => 'view', $usergroupempresa['Usergroupempresa']['id']), array('escape' => false));
                    ...
                    echo $this->Form->postLink($this->Html->image('botoes/excluir.gif', array('alt' => 'Exluir', 'title' => 'Exluir')), array('action' => 'delete', $usergroupempresa['Usergroupempresa']['id']), array('escape' => false), __('Você realmete deseja apagar esse item?')
                    );
                    ?>
                </div>
            </td>
