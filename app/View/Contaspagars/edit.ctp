...
<fieldset>
    ...
    echo $this->Form->input('dtrecebimento', array('id' => 'dtrecebimento', 'class' => 'data', 'type' => 'text', 'label' => 'Recebimento'));
    echo $this->Form->input('dtrepasse', array('id' => 'dtrepasse', 'class' => 'data', 'type' => 'text', 'label' => 'Repasse'));
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $("#dtrecebimento").mask("99/99/9999");
        $("#dtrepasse").mask("99/99/9999");
        $(".data").datepicker({
            dateFormat: 'dd/mm/yy',
