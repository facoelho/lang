...
//        }
    ...
    public function busca_nome_usuario($id = null) {
        $result = $this->User->query('select nome, sobrenome from users where id = ' . $id);

        return $result[0][0]['nome'] . ' ' . $result[0][0]['sobrenome'];
    }
